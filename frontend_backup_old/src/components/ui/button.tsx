  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-300 ease-in-out focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98] transform hover:scale-[1.02]",
  {
    variants: {
      variant: {
        ...
        link: 
          "text-hotel-primary underline-offset-4 hover:underline focus-visible:ring-hotel-primary/20 px-2 py-1",
        success:
          "bg-gradient-to-r from-green-500 to-green-600 text-white shadow-md hover:shadow-lg hover:from-green-600 hover:to-green-700 focus-visible:ring-green-500/25 h-12 px-8 py-3 rounded-xl",
        warning:
          "bg-gradient-to-r from-amber-500 to-amber-600 text-white shadow-md hover:shadow-lg hover:from-amber-600 hover:to-amber-700 focus-visible:ring-amber-500/25 h-12 px-8 py-3 rounded-xl",
        "legacy-default":
      ...
      size: {
        default: "h-12 px-8 py-3 text-base rounded-xl",
        sm: "h-9 px-4 py-2 text-sm rounded-lg",
        lg: "h-14 px-10 py-4 text-lg rounded-xl",
        xl: "h-16 px-12 py-5 text-xl rounded-2xl",
        icon: "h-12 w-12 rounded-xl",
        "legacy-default": "h-11 px-6 py-3 text-sm",
        "legacy-sm": "h-9 px-4 py-2 text-xs rounded-md",
        "legacy-lg": "h-12 px-8 py-4 text-base rounded-xl",
        "legacy-icon": "h-11 w-11 rounded-lg",
      },
    },
    defaultVariants: {
      variant: "default",
